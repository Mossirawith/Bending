    ...
    function loadLastU() {
      ...
      if (data) {
        ['l1','l2','l3','thickness','width','r'].forEach(id => document.getElementById(id).value = data[id] ?? '');
    ...
    function loadLastV() {
      ...
      if (data) {
        ['vleg1','vleg2','vthickness','vwidth','vr'].forEach(id => document.getElementById(id).value = data[id] ?? '');
